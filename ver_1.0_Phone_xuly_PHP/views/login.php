                ...
                <div class="dangnhap">
                    ...
                    <div class="dangnhap-l">
                        ...
                        <DIV class="item-login">
                            ...
                            <input id="dangnhap" name="user" class="login" type="email" placeholder="Email" value="<?php if(isset($userName)){ echo $userName; } ?>" onKeyUp="check()">
                        ...
                        <div class="item-login">
                            ...
                            <input name="passw" class="login" id="matkhau" type="password" placeholder="Tối thiểu 5 ký tự" onKeyUp="check()">
