...
function fixedElement() {
    ...
    window.addEventListener('scroll', function() {
        ...
        if (window.location.href.indexOf('gio_hang.php') != -1) {
...
//         khung.innerHTML += '<a class="use_for_login" href="index.php?' + i + '&' + vt + '">\
...
//         <a class="box" href="thong_tin_sp.php?' + i + '&4">\
//           <div class="hinh-sp">\
...
function phan_tich_url() {
    ...
    for (var i = parseFloat(code[1]); i < sp.length && so_luong < 12; i++) {
        ...
        list_sp[0].innerHTML += '<div class="product-box">\
                      <a class="box" href="thong_tin_sp.php?' + i + '&' + code[0] + '">\
                        <div class="hinh-sp">\
    ...
    for (var i = 1; i <= so_trang; i++) {
        ...
        chuyen_trang.innerHTML +=
            '<a href="index.php?' + code[0] + '&' + code[1] + '" class="so_trang">' + i + '</a>';
    }
            ...
            list_sp.innerHTML += '\
                <div class="cart-item" id="' + box_index + '">\
                    <div class="cart-item-left">\
                        ...
                        <a href="thong_tin_sp.php?' + key_for_url + '" class="cart-heading">' + sp[masp].tensp + '</a><br>\
...
//Cái này cho nút thêm sản phẩm trong trang thong_tin_sp.php
function xac_nhan(e) {
        ...
        for (var j = 0; j < list.length; j++) {
            ...
            if ((name.indexOf(search_value) != -1 || search_value == '') &&
                ...
                document.getElementsByClassName('list_sp')[0].innerHTML += '<div class="product-box">\
                      <a class="box" href="thong_tin_sp.php?' + j + '&' + i + '">\
                        <div class="hinh-sp">\
...
function search() {
    ...
    window.location.href = 'index.php?search=' + spc_to_plus(xoa_dau(search_content)) + '&-1&-1';
}
