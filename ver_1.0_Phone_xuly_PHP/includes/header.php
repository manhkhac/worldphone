...
<form action="" method="get">
    <div class="search_and_cart">
        <div class="search_bar">
            <input type="text" name="search" id="search_txt" required="" placeholder="Tìm ở world phone"><a href="timkiem.php?page=tim_kiem&search=&submit=TÌM"><input type="submit" name="submit" value="TÌM"></a>
...
<div class="nav_wrap">
    <div class="nav">
        ...
        <a id="login" href="index.php?page=login">ĐĂNG NHẬP</a>
        <a id="dang_ky" href="index.php?page=dang_ky">ĐĂNG KÝ</a>
