...
<!-- phần tiêu đề của khung -->
    ...
    <?php 
        ...
        if ($current_page > 1 && $total_page > 1){
            echo '<a href="index.php?page=tim_kiem&page_trang='.($current_page-1).'">Prev</a> | ';
        }
        ...
        for ($i = 1; $i <= $total_page; $i++){
            ...
            if ($i == $current_page){
                ...
                echo '<a href="index.php?page=tim_kiem&page_trang='.$i.'">'.$i.'</a> | ';
            }
        }

        // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
        if ($current_page < $total_page && $total_page > 1){
            echo '<a href="index.php?page=tim_kiem&page_trang='.($current_page+1).'">Next</a> | ';
        }
       ?>
    </div>
    <!-- <div class="chuyen_trang clear_both">
