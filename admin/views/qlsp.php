...
<div class="chuyen_trang clear_both" >
       <?php 
        ...
        if ($current_page > 1 && $total_page > 1){
            echo '<a href="chuyenhuong.php?page=qlsp&page_trang='.($current_page-1).'">Prev</a> | ';
        }
        ...
        for ($i = 1; $i <= $total_page; $i++){
            ...
            if ($i == $current_page){
                ...
                echo '<a href="chuyenhuong.php?page=qlsp&page_trang='.$i.'">'.$i.'</a> | ';
            }
        }

        // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
        if ($current_page < $total_page && $total_page > 1){
            echo '<a href="chuyenhuong.php?page=qlsp&page_trang='.($current_page+1).'">Next</a> | ';
        }
       ?>
    </div>
